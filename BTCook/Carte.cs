...
namespace BTCook
{
    public class Carte
    {
        ...
        /// <summary>
        /// Construit le graphe à partir d'un fichier CSV.
        /// </summary>
        /// <param name="filePath">Le chemin du fichier CSV.</param>
        ...
        /// <summary>
        /// Retrouve les stations de départ et d'arrivée à partir de leurs noms.
        /// </summary>
        /// <param name="departNom">Le nom de la station de départ.</param>
        /// <param name="arriveeNom">Le nom de la station d'arrivée.</param>
        /// <returns>Un tuple contenant les stations de départ et d'arrivée.</returns>
        ...
        /// <summary>
        /// Trouve le chemin optimal entre deux stations en utilisant l'algorithme de Dijkstra.
        /// </summary>
        /// <param name="departNom">Le nom de la station de départ.</param>
        /// <param name="arriveeNom">Le nom de la station d'arrivée.</param>
        /// <returns>Une liste de stations représentant le chemin optimal.</returns>
        ...
        /// <summary>
        /// Trouve le chemin optimal entre deux stations en utilisant l'algorithme de Bellman-Ford.
        /// </summary>
        /// <param name="departId">Le nom de la station de départ.</param>
        /// <param name="arriveeId">Le nom de la station d'arrivée.</param>
        /// <returns>Une liste de stations représentant le chemin optimal.</returns>
        ...
        /// <summary>
        /// Affiche le chemin optimal dans la console.
        /// </summary>
        /// <param name="cheminOptimal">La liste des stations représentant le chemin optimal.</param>
