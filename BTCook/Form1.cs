...
namespace BTCook
{
    ...
    {
        private Carte<string> carte;

        public Form1()
        {
            InitializeComponent();

            carte = new Carte<string>();
            string cheminFichier = @"C:\Users\Utilisateur\OneDrive\Bureau\A2\Problème INFO\BTCook\BTCook\bin\Debug\net8.0-windows\MetroParisModif.csv";
        ...
        private void DessinerGraphe(object sender, PaintEventArgs e)        
        {
            ...
            foreach (var station in carte.Stations.Values)
            {
            ...
            foreach (var station in carte.Stations.Values)
            {
                ...
                // Affichage du nom formaté au centre
                string nomAffiche = station.Nom;
